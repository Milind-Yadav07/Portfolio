    ...
    <section id="contact" className="contact-section" ref={sectionRef}>
      <div className="contact-wrapper">
        ...
        <form className="contact-form staggered-reveal" ref={formRef} onSubmit={sendEmail}>
          <input type="text" name="name" placeholder="Name" className="contact-input staggered-reveal" required />
          <input type="email" name="email" placeholder="Email" className="contact-input staggered-reveal" required />
